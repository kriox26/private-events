...
ActiveRecord::Schema.define(version: 20150818175028) do
  ...
  add_index "events", ["date", "time", "creator_id"], name: "index_events_on_date_and_time_and_creator_id", unique: true
